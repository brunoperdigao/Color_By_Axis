...
classes = (CBA_PT_Main_Panel, CBA_Edges)
...
def register():
    ...
    bpy.types.Scene.axis_type = bpy.props.EnumProperty(
        items=items,
        name="Axis type",
        description="Choose axis type that will affect the overlay",
    )
    ...
    bpy.types.Scene.line_width = bpy.props.FloatProperty(
        name="Line Width", min=1.0, max=8.0, step=5, default=3.0
    )
